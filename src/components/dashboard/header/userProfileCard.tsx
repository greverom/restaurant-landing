...
export default function UserProfileCard({ user }: UserProfileCardProps) {
  ...
  return (
    <div className="w-full max-w-md mx-auto bg-gray-100 dark:bg-gray-800 rounded-xl shadow-md overflow-hidden transition-all hover:shadow-xl">
      <div className="relative">
        {/* Banner decorativo */}
        <div className="absolute top-4 left-0 right-0 h-24 border-b border-gray-300 dark:border-gray-600 opacity-80"></div>
  
        <div className="relative pt-16 px-6 pb-6">
          <div className="flex flex-col items-center">
            {/* Avatar con iniciales */}
            <div className="w-24 h-24 rounded-full bg-gradient-to-br from-gray-200 to-gray-400 flex items-center justify-center
                         text-gray-600 text-2xl font-bold border-1 border-gray-100 dark:border-gray-800 shadow-lg transform hover:scale-105
